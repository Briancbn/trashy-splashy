...
float ACCEL_X_MAX = 261;
float ACCEL_Y_MIN = -281;
float ACCEL_Y_MAX = 271;
float ACCEL_Z_MIN = -305;
...
float magn_ellipsoid_center[3] = {-621.381, -642.522, -535.642};
float magn_ellipsoid_transform[3][3] = {{0.902012, 0.0154100, 0.0770949}, {0.0154100, 0.810800, 0.108156}, {0.0770949, 0.108156, 0.861885}};
// Gyroscope
